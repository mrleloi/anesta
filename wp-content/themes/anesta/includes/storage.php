...
if ( ! function_exists( 'anesta_storage_get_array' ) ) {
	...
	function anesta_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $ANESTA_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $ANESTA_STORAGE[ $var_name ][ $key ] ) ? $ANESTA_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}
