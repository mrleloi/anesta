...
?>">
	<div class="search_form_wrap">
		<form role="search" method="get" class="search_form" action="<?php echo esc_url(home_url('/')); ?>">
			...
			?>" name="post_types">
			<input type="text" class="search_field" placeholder="<?php esc_attr_e('Start typing to search...', 'anesta'); ?>" data-mobile-placeholder="<?php esc_attr_e('Search', 'anesta'); ?>" value="<?php echo esc_attr(get_search_query()); ?>" name="s">
			<button type="submit" class="search_submit trx_addons_icon-search" aria-label="<?php esc_attr_e( 'Start search', 'anesta' ); ?>"></button>
