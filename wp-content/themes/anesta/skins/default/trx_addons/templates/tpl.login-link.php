			...
			if (!empty($args['user_menu'])) {
				?><ul><?php
					...
					if (current_user_can('publish_posts')) {
						?><li class="menu-item trx_addons_icon-wpforms"><a href="<?php echo esc_url( trailingslashit( home_url('/') ) ); ?>wp-admin/post-new.php"><span><?php esc_html_e('New post', 'anesta'); ?></span></a></li><?php
						// Delimiter
						?><li class="menu-item menu-delimiter"></li><?php
					}
					do_action('trx_addons_action_login_menu_settings');
					// Settings
					?><li class="menu-item trx_addons_icon-cog"><a href="<?php echo esc_url( get_edit_user_link() ); ?>"><span><?php esc_html_e('My profile', 'anesta'); ?></span></a></li><?php
					// Delimiter
					?><li class="menu-item menu-delimiter"></li><?php
