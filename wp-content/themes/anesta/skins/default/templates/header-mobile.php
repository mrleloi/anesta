...
// Additional info
if ( anesta_is_off( anesta_get_theme_option( 'header_mobile_hide_info' ) ) ) {
	$anesta_info = anesta_get_theme_option( 'header_mobile_additional_info' );
	if ( '' != $anesta_info ) {
			...
			<div class="content_wrap">
				<div class="columns_wrap">
					<div class="sc_layouts_column sc_layouts_column_align_center sc_layouts_column_icons_position_left column-1_1"><div class="sc_layouts_item">
						<?php
						anesta_show_layout( $anesta_info );
						?>
						</div>
					</div>
				</div>
	...
	<div class="content_wrap">
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_3">
				<?php
				// Logo
				if ( anesta_is_off( anesta_get_theme_option( 'header_mobile_hide_logo' ) ) ) {
					?>
					<div class="sc_layouts_item">
						<?php
						set_query_var( 'anesta_logo_args', array( 'type' => 'mobile_header' ) );
				...
				if ( anesta_exists_trx_addons() ) {
					...
					if ( anesta_is_off( anesta_get_theme_option( 'header_mobile_hide_login' ) ) ) {
						ob_start();
						do_action(
							'anesta_action_login', array(
								'text_login'  => false,
								'text_logout' => false,
							)
						);
					...
					// Display cart button
					if ( anesta_is_off( anesta_get_theme_option( 'header_mobile_hide_cart' ) ) ) {
						ob_start();
						do_action( 'anesta_action_cart' );
						$anesta_action_output = ob_get_contents();
						ob_end_clean();
						if ( ! empty( $anesta_action_output ) ) {
							?>
					...
					if ( anesta_is_off( anesta_get_theme_option( 'header_mobile_hide_search' ) ) ) {
						ob_start();
						do_action(
