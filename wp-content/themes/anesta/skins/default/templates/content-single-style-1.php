...
<?php
	...
	if ( apply_filters( 'anesta_filter_single_post_header', is_singular( 'post' ) || is_singular( 'attachment' ) ) ) {		
		...
		$thumb_bg = in_array($anesta_post_format, array('audio', 'gallery', 'video')) || is_singular( 'attachment' ) ? false : true;
		$thumb_bg = 'audio' == $anesta_post_format && empty( anesta_get_post_audio_list() ) ? true : $thumb_bg;
	...
	<div class="post_footer post_footer_single entry-footer"><?php
		...
		if ( is_single() && ! is_attachment() ) {
			anesta_show_post_footer('pages,tags,share,prev_next,author');
		}
	?></div>
	<?php
