...
class EPKB_Upgrades {
	...
	private static function upgrade_to_v11_31_0( &$kb_config ) {
		...
		if ( empty( $kb_config['article-structure-version'] ) || $kb_config['article-structure-version'] != 'version-1' ) {
			return;
		}
		...
		// recalculate width
		$kb_config = EPKB_Editor_Controller::reset_sidebar_widths( $kb_config );
	}
