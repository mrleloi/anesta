    ...
    class Better_Messages_MultiVendorX
    {
        ...
        public function display_store_button( $return = false ){
            ...
            if( $livechat_enabled ){
                ...
                type="button"
                class="mvx-butn"
                text="' . esc_html_x( 'Live Chat', 'MultiVendorX Integration (Store page)', 'bp-better-messages' ) . '"
                user_id="' . $user_id . '"
            ...
            if (is_product() && $post && is_object($post)) {
                ...
                if( is_user_mvx_vendor( $seller_id ) ){
                    ...
                    if( $livechat_enabled ){
                        ...
                        $subject = sprintf(esc_html_x('Question about your product %s', 'MultiVendorX Integration (Product page)', 'bp-better-messages'), $product->get_title() );

                        $shortcode = do_shortcode('[better_messages_live_chat_button
                        class="bm-style-btn"
                        text="' . esc_html_x('Live Chat', 'MultiVendorX Integration (Product page)', 'bp-better-messages') . '"
                        user_id="' . $seller_id . '"
                        subject="' . $subject . '"
